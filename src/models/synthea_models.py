...
class Encounter(BaseRecord):
    """Encounter model corresponding to encounters.csv using attrs for consistency."""
    Id: str = attr.ib(validator=attr.validators.instance_of(str))
    START: str = attr.ib(validator=attr.validators.instance_of(str))
    PATIENT: str = attr.ib(validator=attr.validators.instance_of(str))
    PROVIDER: str = attr.ib(validator=attr.validators.instance_of(str))
    PAYER: str = attr.ib(validator=attr.validators.instance_of(str))
    ENCOUNTERCLASS: str = attr.ib(validator=attr.validators.instance_of(str))
    CODE: str = attr.ib(converter=str, validator=attr.validators.instance_of(str))
    DESCRIPTION: str = attr.ib(validator=attr.validators.instance_of(str))
    BASE_ENCOUNTER_COST: float = attr.ib(validator=attr.validators.instance_of((int, float)))
    ...
    allergies: List[Allergy] = attr.ib(factory=list, validator=attr.validators.instance_of(list))
    careplans: List[CarePlan] = attr.ib(factory=list, validator=attr.validators.instance_of(list))
    conditions: List[Condition] = attr.ib(factory=list, validator=attr.validators.instance_of(list))
    imaging_studies: List['ImagingStudy'] = attr.ib(factory=list, validator=attr.validators.instance_of(list))
    immunizations: List['Immunization'] = attr.ib(factory=list, validator=attr.validators.instance_of(list))
    medications: List[Medication] = attr.ib(factory=list, validator=attr.validators.instance_of(list))
    observations: List[Observation] = attr.ib(factory=list, validator=attr.validators.instance_of(list))
    procedures: List['Procedure'] = attr.ib(factory=list, validator=attr.validators.instance_of(list))
...
class ImagingStudy(BaseRecord):
    """Imaging Study model corresponding to imaging_studies.csv using attrs for consistency."""
    Id: str = attr.ib(validator=attr.validators.instance_of(str))
    DATE: str = attr.ib(validator=attr.validators.instance_of(str))
    PATIENT: str = attr.ib(validator=attr.validators.instance_of(str))
    ENCOUNTER: str = attr.ib(validator=attr.validators.instance_of(str))
    BODYSITE_CODE: str = attr.ib(converter=str, validator=attr.validators.instance_of(str))
    BODYSITE_DESCRIPTION: str = attr.ib(validator=attr.validators.instance_of(str))
    MODALITY_CODE: str = attr.ib(validator=attr.validators.instance_of(str))
    MODALITY_DESCRIPTION: str = attr.ib(validator=attr.validators.instance_of(str))
    SOP_CODE: str = attr.ib(validator=attr.validators.instance_of(str))
    SOP_DESCRIPTION: str = attr.ib(validator=attr.validators.instance_of(str))
    ...
    def timestamp(self) -> float:
        """Convert date to timestamp using dateutil for robust parsing."""
        try:
            parsed_date = parse_date(self.DATE)
            return parsed_date.timestamp()
        except (ParserError, ValueError, AttributeError):
            return 0.0  # Fallback for invalid dates
...
class Immunization(BaseRecord):
    """Immunization model corresponding to immunizations.csv using attrs for consistency."""
    DATE: str = attr.ib(validator=attr.validators.instance_of(str))
    PATIENT: str = attr.ib(validator=attr.validators.instance_of(str))
    ENCOUNTER: str = attr.ib(validator=attr.validators.instance_of(str))
    CODE: str = attr.ib(converter=str, validator=attr.validators.instance_of(str))
...
class Medication(BaseRecord):
    """Medication model corresponding to medications.csv using attrs for consistency."""
    START: str = attr.ib(validator=attr.validators.instance_of(str))
    PATIENT: str = attr.ib(validator=attr.validators.instance_of(str))
    PAYER: str = attr.ib(validator=attr.validators.instance_of(str))
    ENCOUNTER: str = attr.ib(validator=attr.validators.instance_of(str))
...
class Organization(BaseRecord):
    """Organization model corresponding to organizations.csv using attrs for consistency."""
    Id: str = attr.ib(validator=attr.validators.instance_of(str))
...
class PayerTransition(BaseRecord):
    """Payer Transition model corresponding to payer_transitions.csv using attrs for consistency."""
    PATIENT: str = attr.ib(validator=attr.validators.instance_of(str))
...
class Payer(BaseRecord):
    """Payer model corresponding to payers.csv using attrs for consistency."""
    Id: str = attr.ib(validator=attr.validators.instance_of(str))
    NAME: str = attr.ib(validator=attr.validators.instance_of(str))
    AMOUNT_COVERED: float = attr.ib(validator=attr.validators.instance_of((int, float)))
    AMOUNT_UNCOVERED: float = attr.ib(validator=attr.validators.instance_of((int, float)))
    REVENUE: float = attr.ib(validator=attr.validators.instance_of((int, float)))
    COVERED_ENCOUNTERS: int = attr.ib(validator=attr.validators.instance_of(int))
    UNCOVERED_ENCOUNTERS: int = attr.ib(validator=attr.validators.instance_of(int))
    COVERED_MEDICATIONS: int = attr.ib(validator=attr.validators.instance_of(int))
    UNCOVERED_MEDICATIONS: int = attr.ib(validator=attr.validators.instance_of(int))
    COVERED_PROCEDURES: int = attr.ib(validator=attr.validators.instance_of(int))
    UNCOVERED_PROCEDURES: int = attr.ib(validator=attr.validators.instance_of(int))
    COVERED_IMMUNIZATIONS: int = attr.ib(validator=attr.validators.instance_of(int))
    UNCOVERED_IMMUNIZATIONS: int = attr.ib(validator=attr.validators.instance_of(int))
    UNIQUE_CUSTOMERS: int = attr.ib(validator=attr.validators.instance_of(int))
    QOLS_AVG: float = attr.ib(validator=attr.validators.instance_of((int, float)))
    MEMBER_MONTHS: int = attr.ib(validator=attr.validators.instance_of(int))
...
class Procedure(BaseRecord):
    """Procedure model corresponding to procedures.csv using attrs for consistency."""
    DATE: str = attr.ib(validator=attr.validators.instance_of(str))
    PATIENT: str = attr.ib(validator=attr.validators.instance_of(str))
    ENCOUNTER: str = attr.ib(validator=attr.validators.instance_of(str))
    CODE: str = attr.ib(converter=str, validator=attr.validators.instance_of(str))
...
class Provider(BaseRecord):
    """Provider model corresponding to providers.csv using attrs for consistency."""
    Id: str = attr.ib(validator=attr.validators.instance_of(str))
    ORGANIZATION: str = attr.ib(validator=attr.validators.instance_of(str))
    NAME: str = attr.ib(validator=attr.validators.instance_of(str))
    GENDER: str = attr.ib(validator=attr.validators.instance_of(str))
    SPECIALITY: str = attr.ib(validator=attr.validators.instance_of(str))
    ADDRESS: str = attr.ib(validator=attr.validators.instance_of(str))
    CITY: str = attr.ib(validator=attr.validators.instance_of(str))
    STATE: str = attr.ib(validator=attr.validators.instance_of(str))
    ZIP: str = attr.ib(converter=lambda x: str(x) if x is not None and str(x) != 'nan' else "", validator=attr.validators.instance_of(str))
